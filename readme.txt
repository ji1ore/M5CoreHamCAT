...
--
2026/2/21
M5CoreHamCAT_Speakerの試作版をリリースします。
こちらはM5CoreHamCATの無線機接続画面時、CoreS3SEのポートBに接続したATOMS3Lite(ATOMIC SPK)上に、
SSID、パスワード、ラズパイのアドレスを送付して、ラズパイ上の音声送信サービスと連携してリグ上の音声を
ATOMIC SPKに接続したスピーカーから出力します。

LED色は以下の意味です
オレンジ：情報未取得
緑：情報取得済
青：接続済
緑色になったら、Aキーの長押しで接続状態に移行します。
スピーカーを切りたいときも、Aキーの長押しで切断できます。
※まだかなり不安定で、長押しに10秒以上要する状態/一度でサービスに繋がらないこともある状態です。
--
